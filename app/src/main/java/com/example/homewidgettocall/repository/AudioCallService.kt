...
//
///**
// * Foreground service for audio-only calls
// * Runs in background, works with home widgets
// */
...
//            .setContentText(text)
//            .setSmallIcon(R.drawable.ic_call) // You'll need to add this icon
//            .setContentIntent(openPendingIntent)
//            .setOngoing(true)
//            .setPriority(NotificationCompat.PRIORITY_LOW)
//            .addAction(
//                R.drawable.ic_mic, // You'll need to add this icon
//                if (audioClient?.isMuted() == true) "Unmute" else "Mute",
//                mutePendingIntent
//            )
//            .addAction(
//                R.drawable.ic_call_end, // You'll need to add this icon
//                "End Call",
//                endPendingIntent
//            )
//            .build()
...
//    }
//
//    // Public API for widgets/activities
//
...
//
//        const val ACTION_START_CALL = "com.yourapp.START_CALL"
//        const val ACTION_END_CALL = "com.yourapp.END_CALL"
//        const val ACTION_TOGGLE_MUTE = "com.yourapp.TOGGLE_MUTE"
//        const val ACTION_CALL_STATE_CHANGED = "com.yourapp.CALL_STATE_CHANGED"
//
